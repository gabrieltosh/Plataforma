                      ...
                      <!-- SERVER STATUS PANELS -->
                      	...
                      	<div class="col-md-4 col-sm-4 mb">
                      		<div class="white-panel pn">
								...
								<div class="row">
	                      		...
	                      		<div class="centered">
										<img src="pagina/img/product.png" width="120">
	                      		</div>
                      		</div>
                      	</div><!-- /col-md-4 -->
						<div class="col-md-4 mb">
							...
							<div class="white-panel pn">
								...
								<p><img src="pagina/img/ui-zac.jpg" class="img-circle" width="80"></p>
								<p><b>Zac Snider</b></p>
								<div class="row">
									<div class="col-md-6">
      ...
      *********************************************************************************************************************************************************** -->                  
                  ...
                  <div class="col-lg-3 ds">
                    <!--COMPLETED ACTIONS DONUTS CHART-->
                      ...
                      <div class="desc">
                      	<div class="thumb">
                      		<img class="img-circle" src="pagina/img/ui-divya.jpg" width="35px" height="35px" align="">
                      	</div>
                      	<div class="details">
                      ...
                      <div class="desc">
                      	<div class="thumb">
                      		<img class="img-circle" src="pagina/img/ui-sherman.jpg" width="35px" height="35px" align="">
                      	</div>
                      	<div class="details">
                      ...
                      <div class="desc">
                      	<div class="thumb">
                      		<img class="img-circle" src="pagina/img/ui-danro.jpg" width="35px" height="35px" align="">
                      	</div>
                      	<div class="details">
                      ...
                      <div class="desc">
                      	<div class="thumb">
                      		<img class="img-circle" src="pagina/img/ui-zac.jpg" width="35px" height="35px" align="">
                      	</div>
                      	<div class="details">
                      ...
                      <div class="desc">
                      	<div class="thumb">
                      		<img class="img-circle" src="pagina/img/ui-sam.jpg" width="35px" height="35px" align="">
                      	</div>
                      	<div class="details">
      ...
      <!--main content end-->
      <!--footer start-->
      @include('template.partes.footer')
      <!--footer end-->
  </section>
